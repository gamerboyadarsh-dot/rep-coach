      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 sm:p-12 relative overflow-hidden">
        ...
        <div className="flex flex-col gap-4">
          ...
          <button 
            ...
            disabled={loading}
            className="w-full bg-[#24292F] text-white py-3.5 px-4 rounded-xl font-semibold flex items-center justify-center gap-3 hover:bg-[#24292F]/90 transition-all active:scale-[0.98] disabled:opacity-50"
          >
