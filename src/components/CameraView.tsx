        ...
        <div className="absolute inset-0 flex items-center justify-center bg-slate-950 z-[100]" role="status" aria-live="polite">
          ...
          <div className="flex flex-col items-center relative z-10">
            <div className="relative mb-8">
              <div className="absolute inset-0 bg-lime-500 rounded-full blur-[20px] opacity-40 animate-pulse" />
              <div className="w-20 h-20 bg-slate-900 border border-lime-500/30 rounded-full flex items-center justify-center relative shadow-[0_0_30px_rgba(59,130,246,0.2)]">
